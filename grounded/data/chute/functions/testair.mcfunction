execute at @e[type=minecraft:marker,name="Chute"] if block ~ ~ ~ minecraft:air run function chute:spawnchute
execute at @e[type=minecraft:marker,name="Chute"] if block ~ ~ ~ minecraft:cave_air run function chute:spawnchute
